...
public class RefreshRecyclerView extends WrapRecyclerView {
    ...
    // 默认状态
    public int REFRESH_STATUS_NORMAL = 0;
    // 下拉刷新状态
    public int REFRESH_STATUS_PULL_DOWN_REFRESH = 1;
    // 松开刷新状态
    public int REFRESH_STATUS_LOOSEN_REFRESHING = 2;
    // 正在刷新状态
    public int REFRESH_STATUS_REFRESHING = 3;
    // 手指按下的Y位置
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mRefreshView != null && mRefreshViewHeight <= 0) {
            ...
            if (mRefreshViewHeight > 0) {
                //隐藏头部刷新的View marginTop多留出1px防止无法判断是不是滚动到头部问题
